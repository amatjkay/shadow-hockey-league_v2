...
/**
 * AuthOauthClientWithTokenCount model
 *
 * @param request - function to call the graphql client
 * @param data - L.AuthOauthClientWithTokenCountFragment response data
 */
export declare class AuthOauthClientWithTokenCount extends Request {
    constructor(request: LinearRequest, data: L.AuthOauthClientWithTokenCountFragment);
...
export declare class CustomerNeed extends Request {
     ...
     */
    updatedAt: Date;
    /** [DEPRECATED] Optional URL to the source of the customer need. Used when manually creating a need. */
    url?: string;
...
/**
 * MeetingConnection model
 *
 * @param request - function to call the graphql client
 * @param fetch - function to trigger a refetch of this MeetingConnection model
 * @param data - MeetingConnection response data
 */
export declare class MeetingConnection extends Connection<Meeting> {
    constructor(request: LinearRequest, fetch: (connection?: LinearConnectionVariables) => LinearFetch<LinearConnection<Meeting> | undefined>, data: L.MeetingConnectionFragment);
}
/**
 * Node model
 *
 ...
 */
export declare class NotificationCategoryMetadata extends Request {
    constructor(request: LinearRequest, data: L.NotificationCategoryMetadataFragment);
 ...
 */
export declare class NotificationCategoryPreferencesMetadata extends Request {
    constructor(request: LinearRequest, data: L.NotificationCategoryPreferencesMetadataFragment);
    /** The metadata for notifications about apps and integrations. */
    appsAndIntegrations: NotificationCategoryMetadata;
    /** The metadata for notifications about assignments. */
    assignments: NotificationCategoryMetadata;
    /** The metadata for notifications about comments and replies. */
    commentsAndReplies: NotificationCategoryMetadata;
    /** The preferences for customer notifications. */
    customers: NotificationCategoryMetadata;
    /** The metadata for notifications about document changes. */
    documentChanges: NotificationCategoryMetadata;
    /** The metadata for notifications about mentions. */
    mentions: NotificationCategoryMetadata;
    /** The metadata for notifications about posts and updates. */
    postsAndUpdates: NotificationCategoryMetadata;
    /** The metadata for notifications about reactions. */
    reactions: NotificationCategoryMetadata;
    /** The metadata for notifications about reminders. */
    reminders: NotificationCategoryMetadata;
    /** The metadata for notifications about reviews. */
    reviews: NotificationCategoryMetadata;
    /** The metadata for notifications about status changes. */
    statusChanges: NotificationCategoryMetadata;
    /** The metadata for notifications about subscriptions. */
    subscriptions: NotificationCategoryMetadata;
    /** The preferences for system notifications. */
    system: NotificationCategoryMetadata;
    /** The preferences for triage notifications. */
    triage: NotificationCategoryMetadata;
}
/**
 ...
 */
export declare class PartialNotificationCategoryPreferences extends Request {
    constructor(request: LinearRequest, data: L.PartialNotificationCategoryPreferencesFragment);
    /** The preferences for notifications about apps and integrations. */
    appsAndIntegrations?: PartialNotificationChannelPreferences;
    /** The preferences for notifications about assignments. */
    assignments?: PartialNotificationChannelPreferences;
    /** The preferences for notifications about comments and replies. */
    commentsAndReplies?: PartialNotificationChannelPreferences;
    /** The preferences for notifications about customers. */
    customers?: PartialNotificationChannelPreferences;
    /** The preferences for notifications about document changes. */
    documentChanges?: PartialNotificationChannelPreferences;
    /** The preferences for notifications about mentions. */
    mentions?: PartialNotificationChannelPreferences;
    /** The preferences for notifications about posts and updates. */
    postsAndUpdates?: PartialNotificationChannelPreferences;
    /** The preferences for notifications about reactions. */
    reactions?: PartialNotificationChannelPreferences;
    /** The preferences for notifications about reminders. */
    reminders?: PartialNotificationChannelPreferences;
    /** The preferences for notifications about reviews. */
    reviews?: PartialNotificationChannelPreferences;
    /** The preferences for notifications about status changes. */
    statusChanges?: PartialNotificationChannelPreferences;
    /** The preferences for notifications about subscriptions. */
    subscriptions?: PartialNotificationChannelPreferences;
    /** The preferences for notifications about triage. */
    triage?: PartialNotificationChannelPreferences;
}
/**
 ...
 */
export declare class PartialNotificationChannelPreferences extends Request {
    constructor(request: LinearRequest, data: L.PartialNotificationChannelPreferencesFragment);
    /** Whether notifications are currently enabled for desktop. */
    desktop?: boolean;
    /** Whether notifications are currently enabled for email. */
    email?: boolean;
...
export declare class CustomerNeedQuery extends Request {
     ...
     *
     * @param id - required id to pass to customerNeed
     * @returns parsed response from CustomerNeedQuery
     */
    fetch(id: string): LinearFetch<CustomerNeed>;
}
/**
...
export declare class LinearSdk extends Request {
     ...
     */
    customerNeed(id: string): LinearFetch<CustomerNeed>;
    /**
     * All customer needs.
     *
     * @param variables - variables to pass into the CustomerNeedsQuery
     ...
     * @returns DeletePayload
     */
    deleteCustomerNeed(id: string): LinearFetch<DeletePayload>;
    /**
     * Unarchives a customer need.
     *
     * @param id - required id to pass to unarchiveCustomerNeed
