...
const getToolDescription = (description) => {
    const prefix = process.env.TOOL_PREFIX;
    return prefix
...
export const toolSchemas = {
    ...
    [getToolName("linear_edit_issue")]: {
        ...
        description: getToolDescription("Edit an existing issue, updating any of its fields. Note: When setting projectMilestoneId, you must also set projectId."),
        inputSchema: {
            type: "object",
            properties: {
                issueId: {
    ...
    [getToolName("linear_get_issue")]: {
        ...
        description: getToolDescription("Get a single issue by identifier, including all comments"),
        inputSchema: {
            type: "object",
            properties: {
                identifier: {
    ...
    [getToolName("linear_list_projects")]: {
        ...
        description: getToolDescription("List all projects or filter them by criteria"),
        inputSchema: {
            type: "object",
            properties: {
                filter: {
    ...
    [getToolName("linear_get_project_milestones")]: {
        ...
        description: getToolDescription("Get milestones for a project with filtering and pagination"),
        inputSchema: {
            type: "object",
            properties: {
                projectId: {
