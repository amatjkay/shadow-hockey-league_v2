...
managers = [
    ...
    Manager("Alex Rybakov", "/static/img/flags/rus.png",
           ['<img src="/static/img/cups/top1.svg" title="Shadow 2 league TOP1 s24/25">']),
    ...
    Manager("Zhanabil Au", "/static/img/flags/kz.png",
           ['<img src="/static/img/cups/clap-b.svg" title="Shadow 2 league Round 3 s24/25">']),
    Manager("xMoneyMaker 1", "/static/img/flags/rus.png",
           ['<img src="/static/img/cups/top2.svg" title="Shadow 2 league TOP2 s24/25">']),
    Manager("Aleksejs Lazarenko", "/static/img/flags/rus.png",
           ['<img src="/static/img/cups/top3.svg" title="Shadow 2 league TOP3 s24/25">']),
    Manager("Dias Kazbekuly", "/static/img/flags/rus.png"),
    Manager("Tandem: Vladislav B, Ilnaz Akhtyamov", "/static/img/flags/rus.png"),
