"""Achievement endpoints: bulk-create, bulk-add, manager listing, delete.

Helpers extracted in TIK-44 keep ``bulk_create_achievements`` and
``bulk_add_achievements`` at cyclomatic complexity ≤ C.
"""
...
def _build_skip_record(
    ...
    """Construct a skip-record for an already-existing achievement."""
    return {
        "type_id": type_id,
